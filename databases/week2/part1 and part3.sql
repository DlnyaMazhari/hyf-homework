...
-- Part 1 : Part 1: Working with tasks

-- Add a task with these attributes: title, description, created, updated, due_date, status_id, user_id
insert into task
( title, description, created, updated, due_date, status_id)
values ( 'adding a new task', 'learning how to add a row into a table', now(), '2021-01-27 19:19:56', '2021-01-23 10:13:42', 3);
SELECT * FROM task;

-- Change the title of a task

UPDATE task 
SET title= 'hang up painting in the living romm plus hanging the clock'
WHERE id= 33;
